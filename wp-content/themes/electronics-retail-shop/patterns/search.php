 ...
 * Search Section
 * 
 * slug: electronics-retail-shop/search-page
 * title: Search Page
 * categories: electronics-retail-shop
 */

return array(
    'title'      =>__( 'Search Page', 'electronics-retail-shop' ),
...
<h2 class="wp-block-heading has-text-align-center">'. esc_html__(' No results found','electronics-retail-shop') .'</h2>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"center"} -->
<p class="has-text-align-center"> '. esc_html__('  We could not find any posts matching your search. Try different keywords.','electronics-retail-shop') .'</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
