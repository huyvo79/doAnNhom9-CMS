    ...
    <div class="container-fluid d-none border-bottom d-lg-block bg-dark">
        <div class="row gx-0 align-items-center">
            ...
            <div class="col-lg-4 text-center d-flex align-items-center justify-content-center">
                ...
                <a href="tel:<?php echo esc_attr(preg_replace('/[^0-9+]/', '', $shop_hotline)); ?>"
                    class="text-white-50">
                    ...
                    <?php if (class_exists('WooCommerce')): ?>
                        <a href="<?php echo wc_get_cart_url(); ?>"
                            ...
                            <span class="text-dark ms-2 text-start">
                                ...
                                <small class="text-muted">(<?php echo WC()->cart->get_cart_contents_count(); ?>
                                    items)</small>
                            </span>
                        </a>
                    <?php endif; ?>
        ...
        <div class="row gx-0 bg-primary px-5 align-items-center">
            ...
            <div class="col-lg-3 d-none d-lg-block">
                <nav class="navbar navbar-light position-relative hover-open" style="width: 250px;">
                    <button class="navbar-toggler border-0 fs-4 w-100 px-0 text-start text-white" type="button"
                        data-bs-toggle="collapse" data-bs-target="#allCat">
                        <h4 class="m-0 text-white"><i class="fa fa-bars me-2"></i>Danh mục</h4>
                    </button>

                    <div class="collapse navbar-collapse rounded-bottom bg-white position-absolute w-100" id="allCat"
                        style="z-index: 999; top: 100%; border: 1px solid #ddd;">
                ...
                <nav class="navbar navbar-expand-lg navbar-light bg-primary ">
                    ...
                    <div class="collapse navbar-collapse" id="navbarCollapse">
                        ...
                        <div class="d-none d-lg-block ms-3">
                            <a href="tel:<?php echo esc_attr(preg_replace('/[^0-9+]/', '', $shop_hotline)); ?>"
                                class="btn btn-secondary rounded-pill py-2 px-4 px-lg-3">
